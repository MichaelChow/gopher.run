...
1. 手动加载env和source venv/bin/activate，最后以sudo身份读取env并启动。
...
deepAgent论文地址（中国人大学生和小红书员工的论文）：[https://arxiv.org/html/2510.21618?_immersive_translate_auto_translate=1](https://arxiv.org/html/2510.21618?_immersive_translate_auto_translate=1)
